...
// Data Compression
// Practical 7: 'LZ77' Compression and Decompression Algorithm
...
int main(int argc, char* argv[]) {
    ...
    if (d_or_c!='c' && d_or_c!='d') {
        ...
        // Start decompression
        printf("Enter your file name or file path(if in different directory) for OUTPUT: ");
